  ...
  return (
    <header className="container mx-auto px-4 pt-4">
      <div className="relative flex items-center justify-center">
        <h1 className="text-xl font-bold text-center text-shadow-md px-3 py-1 rounded-lg bg-white/20 backdrop-blur-sm border border-white/30">Lorene's Color Mixer</h1>
